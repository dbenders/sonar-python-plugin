 ...
 */
package org.sonar.plugins.python.surefire;
...
public class PythonSurefireSensor implements Sensor {

  private static Logger logger = LoggerFactory.getLogger(PythonSurefireSensor.class);
  ...
  protected void collect(Project project, SensorContext context, File reportsDir) {
    ...
    new AbstractSurefireParser() {
      ...
      protected Resource<?> getUnitTestResource(String classKey) {
        return new PythonFile(classKey, true);
      }
